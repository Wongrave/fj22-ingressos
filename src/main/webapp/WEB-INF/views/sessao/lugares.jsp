							...
							<table>
								...
								<c:forEach var="lugar" items="${map.value}">
									<td class="fileira-assento"><figure>
										<svg
															class="assento	${sessao.isDisponivel(lugar) && !carrinho.isSelecionado(lugar,sessao) ? 'disponivel' : 'ocupado'}"
															onclick="${sessao.isDisponivel(lugar) && !carrinho.isSelecionado(lugar,sessao) ? 'changeCheckbox(this)' : '' }"
